...
const SingleBill: FC<Bill> = (props) => {
  ...
  return (
    <div className="single-bill p-5 rounded-2xl">
      ...
      <div style={{marginTop: '10px', marginBottom: '10px', backgroundColor:'#d7d7d7', padding : '5px', borderRadius: '10px'}}><small style={{}}>{window.location.origin + '//new-invoice?invoice_id=?' + unique_url_param}</small></div>
